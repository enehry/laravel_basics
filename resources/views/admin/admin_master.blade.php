            ...
            <ul class="nav navbar-nav">
              ...
              <li class="dropdown user-menu">
                <button href="#" class="dropdown-toggle nav-link" data-toggle="dropdown">
                  <img src="{{ asset('storage/'.Auth::user()->profile_photo_path) }}" class="user-image" alt="User Image" />
                  <span class="d-none d-lg-inline-block">{{ Auth::user()->name }}</span>
                </button>
                <ul class="dropdown-menu dropdown-menu-right">
                  <!-- User image -->
                  <li class="dropdown-header">
                    <img src="{{ asset('storage/'.Auth::user()->profile_photo_path) }}" class="img-circle" alt="User Image" />
                  ...
                  <li>
                    <a href="{{ route('admin.change_pass') }}"> <i class="mdi mdi-settings"></i> Account Setting </a>
                  </li>
